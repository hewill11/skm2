...
# Назначение: SSH на HQ-RTR для Ansible — net_admin, парольный вход, порт 22
# Билет / задание: Сконфигурируйте ansible на BR-SRV (часть HQ-RTR)
# ОС: Debian 13
...
# ss -tlnp | grep ':22'
# id net_admin
# с BR-SRV: sshpass -p 'P@ssw0rd' ssh net_admin@192.168.100.1 'echo ok'
