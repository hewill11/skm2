...
# Назначение: Статическая трансляция портов (DNAT) на BR-RTR -> BR-SRV (8080, 2026) + masquerade
# Билет / задание: Задание 8 (часть BR-RTR)
# ОС: Debian 13
# Основано на: методичка (скрин /etc/nftables.conf, iifname ens3, dnat to 192.168.200.2)
...
# с ISP: ssh sshuser@172.16.2.2 -p 2026
# с ISP: curl -I http://172.16.2.2:8080
